...
import com.example.thecocktailsapp.viewmodule.CocktailsAppViewModel
...
class CocktailsAppViewModelTest {
    ...
    private lateinit var testObject: CocktailsAppViewModel
    ...
    fun setUp() {
        ...
        testObject = CocktailsAppViewModel(mockRepository, mockDispatcher)
    }
